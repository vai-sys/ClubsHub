...
//       console.log("faculty-approved",response)
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <Card className="p-6 mb-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Faculty Approved Events</h1>
            <p className="text-gray-600 mt-2">Total events pending approval: {events.length}</p>
          </div>
