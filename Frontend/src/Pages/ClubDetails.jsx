...
//               alt={`${club.name} Logo`}
//               className="h-32 w-32 rounded-2xl object-cover shadow-lg ring-4 ring-blue-50"
//             />
...
//                     <span className="inline-flex items-center px-4 py-2 bg-blue-50 rounded-xl text-sm font-medium">
//                       <Users className="h-4 w-4 text-blue-600 mr-2" />
//                       {club.clubMembers?.length || 0} Members
//                     </span>
//                     {club.isActive && (
//                       <span className="inline-flex items-center px-4 py-2 bg-green-50 rounded-xl text-sm font-medium">
...
//                   </div>
//                 </div>
//                 <button className="px-6 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-all shadow-md hover:shadow-xl transform hover:-translate-y-0.5 active:transform-none text-sm font-medium">
//                   Join Club
//                 </button>
//               </div>
              
//               <p className="mt-4 text-gray-600 leading-relaxed">{club.description}</p>
...
//                   <Calendar className="h-12 w-12 mx-auto mb-3 text-blue-600/20" />
...
//                 </div>
//                 <div className="text-center py-8">
//                   <Bell className="h-12 w-12 mx-auto mb-3 text-blue-600/20" />
...
//             {/* Club Leadership */}
//             <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow">
//               <h2 className="text-xl font-bold text-gray-900 mb-6">Club Leadership</h2>
...
//                     <Users className="h-12 w-12 mx-auto mb-3 text-blue-600/20" />
